...
////#include "Header.h"
//
//class Tatra; // Объявляем класс Tatra, чтобы его можно было использовать в дружественной функции FrCreater()
//
//class Kamaz {
//private:
//    std::string name;
...
//    }
//
//    friend int FrCreater2(const Kamaz& kamaz, const Tatra& tatra); // Дружественная функция
//};
//
//class Tatra {
//private:
